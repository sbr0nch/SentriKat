...
# Product read endpoints get_product_installations and
# get_product_version_history have moved to app/routes_products.py as
# the first slice of the M-1 split. The blueprint is registered in
# app/__init__.py; URL paths are unchanged.
