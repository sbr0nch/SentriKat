...
def _add_report_integrity(report_data, generated_by_user=None):
    ...
    audit = {
        ...
        'generator': 'SentriKat Vulnerability Management Platform',
    ...
    report_data['attestation'] = {
        'statement': (
            'This report was automatically generated by SentriKat based on vulnerability '
    ...
    report_data['document_integrity'] = {
        ...
        'verification_note': (
            ...
            'The HMAC signature can only be verified by the generating SentriKat instance.'
        ),
    }
